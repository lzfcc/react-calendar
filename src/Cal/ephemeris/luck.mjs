...
export const YearGodConvert = (a, b, YearScOrder, YuanYear) => {
  ...
  const YearBranchFive =
    Math.round(((tmp % 3) + 3) % 3.1) / 3 > 0.5
      ? FiveList2[tmp2 - 1]
      : FiveList2[tmp2];
  ...
  const YearGod =
    ...
    YearBranchFive +
    "，納音" +
    NayinList[Math.ceil(YearScOrder / 2)] +
    "。" +
    MaleFemale +
    "。魁" +
    NumList[KuiMon] +
...
const YearColorConvert_BACKUP = (YuanYear) => {
  ...
  if (YuanYear > 0) {
    ...
    const row1a =
      `<span class='${ClassColorList[row1an]}'>` +
      ColorList[row1an] +
      NumList[row1an + 1] +
      "</span>";
    const row1b =
      `<span class='${ClassColorList[row1bn]}'>` +
      ColorList[row1bn] +
      NumList[row1bn + 1] +
      "</span>";
    const row1c =
      `<span class='${ClassColorList[row1cn]}'>` +
      ColorList[row1cn] +
      NumList[row1cn + 1] +
      "</span>";
    const row2a =
      `<span class='${ClassColorList[row2an]}'>` +
      ColorList[row2an] +
      NumList[row2an + 1] +
      "</span>";
    const row2b =
      `<span class='${ClassColorList[row2bn]}'>` +
      ColorList[row2bn] +
      NumList[row2bn + 1] +
      "</span>";
    const row2c =
      `<span class='${ClassColorList[row2cn]}'>` +
      ColorList[row2cn] +
      NumList[row2cn + 1] +
      "</span>";
    const row3a =
      `<span class='${ClassColorList[row3an]}'>` +
      ColorList[row3an] +
      NumList[row3an + 1] +
      "</span>";
    const row3b =
      `<span class='${ClassColorList[row3bn]}'>` +
      ColorList[row3bn] +
      NumList[row3bn + 1] +
      "</span>";
    const row3c =
      `<span class='${ClassColorList[row3cn]}'>` +
      ColorList[row3cn] +
      NumList[row3cn + 1] +
      "</span>";
...
export const FubaoConvert = (iRaw, Stem) => {
  // 復日（報日、重日）
