export default {
    ...
    Taichu: {
        ...
        TongRange: 1539, // 統法
        isTermLeap: 1,
        // MansionRaw: [7, 26], // 牽牛初度。
        MansionRaw: [8, 0], // 這兩個結果都等於牛0
        MansionFracPosi: 7,
        EcliRange: 135 / 23,
        EcliNumer: 513,
        Node: 27 + 187 / 879,
    ...
    Qianxiang: {
        ...
        ZhangRange: 19,
        ZhangLeap: 7,
        MansionRaw: [7, 22], // 斗22度
        MansionFracPosi: 7, // 斗分所加在斗
        Sobliq: 23.9, // 據緯度最大值
    },
    ...
    Liuzhi: { // 晉志下、開元占經。武帝侍中平原劉智，以斗曆改憲，推四分法，三百年而減一日，以百五十爲度法，三十七爲斗分。推甲子爲上元，至泰始十年，歲在甲午，九萬七千四百一十一歲，上元天正甲子朔夜半冬至，日月五星始于星紀，得元首之端。飾以浮說，名爲正曆。
        ...
        ZhangRange: 19,
        ZhangLeap: 7,
        MansionRaw: [7, 21], // 占經：冬至斗21度.晉志：[25, 0]
        MansionFracPosi: 7, // 闕
    },
    Wangshuozhi: { // 晉志
        Type: 2,
    ...
    Sanji: { //晉書律曆下，開元占經卷105。始悟以月食衝檢日宿度所在。劉洪濤238頁
        ...
        ZhangRange: 19,
        ZhangLeap: 7,
        MansionRaw: [7, 17], // 占經：斗17度，《中國數理天文學》頁193
        MansionFracPosi: 7, // 闕
    },
    ...
    Tsrengguang: {
        ...
        MansionRaw: [7, 15], // 斗15度
        MansionFracPosi: 7, // 經斗除分
    },
    Xinghe: {
        Type: 3,
        ApplyYear: [[540, 550]],
    ...
    Tianbao: { // https://github.com/kanasimi/CeJS/blob/master/data/date/calendar.js // 嚴敦傑《補北齊書曆志》，《自然科學史研究》1984年第3期
        ...
        ZhangRange: 676, // 章歲
        ZhangLeap: 249,
        MansionRaw: [7, 15], // 「命起牛前十二度」斗15
        MansionFracPosi: 7, // 闕，應該就是斗分
    },
    ...
    Daxiang: { // https://github.com/kanasimi/CeJS/blob/master/data/date/calendar.js 大象元年，太史上士馬顯等，又上《丙寅元曆》...上元丙寅至大象元年己亥，積四萬一千五百五十四算上。日法五萬三千五百六十三，亦名蔀會法。章歲四百四十八，斗分三千一百六十七，蔀法一萬二千九百九十二。章中爲章會法。日法五萬三千五百六十三，曆餘二萬九千六百九十三，會日百七十三，會餘一萬六千六百一十九，冬至日在斗十二度。小周餘、盈縮積，其曆術別推入蔀會，分用陽率四百九十九，陰率九。每十二月下各有日月蝕轉分，推步加減之，乃爲定蝕大小餘，而求加時之正。
        ...
        ZhangRange: 448, // 章法
        ZhangLeap: 165,
        MansionRaw: [7, 12], // 斗12度
        MansionFracPosi: 7, // 闕，擬
    },
    ...
    Yuanjia: {
        ...
        ZhangRange: 19,
        ZhangLeap: 7,
        // MansionRaw: [12, 2], // 劉洪濤頁251：冬至在斗17，雨水日在室2度。由於日行盈縮，雨水本來是4度265+20/24分
        MansionRaw: [12, 1 + 5 / 6], // 《中國古代曆法》27頁
        MansionFracPosi: 12, // 經室去度分
    ...
    Daming: {
        ...
        OriginMonNum: 0, // 
        ZhengNum: 2, // 建寅
        MansionRaw: [10, 0], // 上元虛初度。從上元到463年，大概退了35度，從虛初退，正好是斗12左右
        MansionFracPosi: 9, // 虛前，入虛去度分 
    ...
    Yukuo: { // 開元占經「梁武大同」，虞𠠎。用來補明克讓。只有以下信息：《隋志中》「初，西魏入關，尚行李業興《正光術》。至武成元年，始詔克讓與麟趾學士庾季才及諸日者定新術，采祖暅舊議，通簡南北之術。自斯已後，頗親其謬。故周齊並時，而曆差一日。」日度議「梁武帝據虞𠠎曆，百八十六年差一度」跟元嘉大概三年有兩年差一天。陳久金《符天曆研究》：祖暅的符天經與後來的符天曆毫無關係。「采祖暅舊議」說明與大明很接近
        // 我根據大衍曆議的歲差，補出恆星年
        Type: 4,
        ApplyYear: [[559, 565]],
    ...
    Wuyin: { // 戊寅定朔 // 崔善爲修改的戊寅曆未改動傅仁均原始數據，《中國古代曆法》第460頁
        ...
        OriginMonNum: 0, // 
        ZhengNum: 2, // 建寅
        MansionRaw: [10, 6], // 命以虛六
        MansionFracPosi: 7, // 經斗去分
    ...
    Linde: {
        ...
        WeekConst: 1,
        MansionDayConst: -20,
        MansionRaw: [7, 12], // 斗12。這估計是黃道度，但是沒說赤道度，奇怪
        MansionFracPosi: 7, // 沒說
    ...
    Dayan: {
        ...
        MansionRaw: [10, 9],
        MansionFracPosi: 10, // 命起赤道虛九，宿次去之，經虛去分，至不滿宿算外，得冬至加時日度。
    ...
    Wuji: { // 新唐志五
        ...
        WeekConst: 1,
        MansionDayConst: -20,
        MansionRaw: [10, 4], // 上元七曜，起赤道虛四度。
        MansionFracPosi: 10, // 闕
    ...
    Chongxuan: { // 新唐志六下。崇玄發揚了符天的公式化，符天：平行實行差=(182-平行度)*平行度/3300「相減相乘」。陳美東《中國古代有關曆表及其算法的公式化》，《自然科學史研究》1988年第3期
        ...
        MansionDayConst: -16,
        MansionRaw: [10, 4],
        MansionFracPosi: 10, // 其上元七曜，起赤道虛四度。
    ...
    Yingtian: { // 宋志一
        ...
        OriginMonNum: 0,
        ZhengNum: 2,
        MansionRaw: [10, 4], // 命起赤道虛宿四度分
        MansionFracPosi: 10, // 虛分
    ...
    Shoushi: { // 授時曆經
        ...
        MansionRaw: [10, 6], // 命起赤道虛宿六度外，實際上曆元是箕10
        MansionFracPosi: 10,
    ...
    Jiazi: { // 曆象考成
        ...
        MansionRaw: [10, 3.16666666666667],
